...
---
<!-- Porte Kiro -> Claude Code: allowed-tools original era "readFile readMultipleFiles fsWrite discloseContext". "discloseContext" (carregar outro steering/skill no contexto) não existe como tool no Claude Code — o equivalente funcional é ler diretamente o arquivo de steering/skill relevante com Read, o que este skill já faz. Ver PORTING-NOTES.md. Nenhum outro conteúdo desta skill foi alterado. -->

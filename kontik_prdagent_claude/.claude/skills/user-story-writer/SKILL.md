...
---
<!-- Porte Kiro -> Claude Code: allowed-tools original era "readFile readMultipleFiles fsWrite strReplace". Ver PORTING-NOTES.md para o mapeamento completo. Nenhum outro conteúdo desta skill foi alterado. -->
